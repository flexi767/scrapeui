...
function normalizeCarsBgImages(urls: Array<string | null | undefined>): string[] {
  ...
  if (existing) {
    ...
    db.prepare(`
      UPDATE listings SET
        ...
        reg_year = ?, last_edit = ?, carsbg_title = ?, carsbg_created_date = ?, carsbg_edited_date = ?, cars_price = ?, ${imageFields}
